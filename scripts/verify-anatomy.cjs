...
(async()=>{
 ...
 try{
  ...
  await page.waitForFunction(()=>document.querySelector('.anatomy-canvas canvas').dataset.visibleLayers==='nerves');
  ...
  for(let cycle=0;cycle<2;cycle++){
   ...
   await page.locator('[data-anatomy-action="cutaway"]').click();
   await page.waitForFunction(()=>document.querySelector('.anatomy-canvas canvas').dataset.visibleLayers==='nerves',null,{timeout:90000});
