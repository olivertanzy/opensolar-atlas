...
(async()=>{
 ...
 report.solidPlaceholder=await page.evaluate(()=>!SOLAR_TEST.meshes.get('999').material.wireframe&&SOLAR_TEST.meshes.get('999').material.uniforms.placeholder.value===1);
